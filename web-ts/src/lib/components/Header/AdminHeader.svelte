...
<header class="flex items-center justify-between px-[24px] py-[12px] bg-primary">
	<div class="flex gap-12 items-center">
		...
		<div class="flex gap-6 items-center">
            <a class="font-semibold text-[#fff] text-base" href="/admin/fundraisers">Fundraisers</a>

			<a class="font-semibold text-[#fff] text-base" href="/admin/categories">Categories</a>

			<a class="font-semibold text-[#fff] text-base" href="/admin/campaigns">Campaigns</a>
		</div>
	</div>
